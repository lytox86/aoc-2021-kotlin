...
fun main() {
    ...
    fun part1(input: List<String>): Long {
        return Maze.from(input).computeMinEnergyToOrder()
    }

    fun part2(input: List<String>): Long {
        return Maze.unfoldRooms(Maze.from(input)).computeMinEnergyToOrder()
    }
   ...
   // test if implementation meets criteria from the description, like:
    ...
    println(part1(input)) // 18195
    println(part2(input)) // 50265
}